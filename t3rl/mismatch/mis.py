"""
Training-Inference Mismatch (TIS) utilities for importance sampling weights.

Copied from slime/examples/train_infer_mismatch_helper/mis.py to avoid PYTHONPATH issues.
"""
