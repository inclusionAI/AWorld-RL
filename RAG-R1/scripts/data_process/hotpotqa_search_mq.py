...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='../../data/hotpotqa_train_filter_mq')
    parser.add_argument('--hdfs_dir', default=None)
    parser.add_argument('--template_type', type=str, default='base')

    args = parser.parse_args()

    data_source = 'hotpotqa_train_filter_mq'
    data_files = {"train": args.local_dir + "/train_data.json", "test": args.local_dir + "/test_data.json"}
